...
export class AddRefreshTokenCascade1745613078979 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_265bec4e500714d5269580a0219"`);
